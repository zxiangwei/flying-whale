    ...
    ui(new Ui::Widget)
{
    ...
    //QDesktopScreenWidget*pDesktopwidget=QApplication::desktop();
...
//    std::cout<<screenW;
    //ui->label_5->setText((QString)to_string(screenW).c_str());
    //ui->label_6->setText((QString)screenW);
    x=200;
    y=200;
    x1=100;
    y1=100;
...
void Widget::star()
{
   ...
   {
         A temp1;
    temp1.a=rand()%screenW;
    temp1.b=80+rand()%screenH;
    vv.push_back(temp1);
    }
...
{
       QPainter painter(this);
       painter.fillRect(QRect(0,screenH-100,750,15), QBrush(Qt::darkRed));
       painter.fillRect(QRect(0,screenH-100,MyHurt,14),QBrush(Qt::white));
...
{    
     QPainter painter(this);
     painter.fillRect(QRect(screenW*0.5,screenH-100,750,15), QBrush(Qt::blue));
     painter.fillRect(QRect(screenW*0.5,screenH-100,used,15), QBrush(Qt::white));
...
void Widget::Night()
{
    ...
    painter.setBrush(brush);}
    painter.drawRect(0, 0,screenW, screenH);
...
void Widget:: paintEvent(QPaintEvent* ev)//paint
{
    ...
    FailAvoid();
    MyResource();
    QString s=(QString)("Time:"+std::to_string((clock()-t)/1000)+'s').c_str();
//     ui->lineEdit->setText(s);
    QPainter painter(this);
    QPen pen(QColor(0,0,0));
    painter.setPen(pen);
    painter.drawText(screenW*0.8,screenH*0.3,s);
    update();
}
 ...
 void Widget:: timerEvent(QTimerEvent *ev)//timer
{
     ...
     if(ev->timerId()==t1)
     {
        ...
        keyPressEvent(ev);*/
         ...
         switch(c)
         {
         case 1:y=y-12;if(y<60)y=60;update();break;
         case 2:y=y+12;if(y>(screenH-100-12.5-15))y=(screenH-100-12.5-15);update();break;
         case 3:x=x+12;if(x>(screenW-25))x=screenW-25;update();break;
